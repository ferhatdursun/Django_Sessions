...
'''
    def get_queryset(self):
        filter_result = self.queryset
        get_first_name = self.request.query_params.get('first_name')
        if get_first_name is not None:
            filter_result = filter_result.filter(first_name__contains=get_first_name)
